...
describe("TC1 - Bartesian 4oz Sachets 6600 MOQ", () => {
  const formData: ProjectFormData = {
    ...
    intakeFeeMarkup:         "25",
    testingEnabled:          "true",
    testingRows:             [{ id: "1", testType: "COA", customTestName: "", cost: 350 }],
    testingMarkup:           "30",
...
describe("Inner/Case guard - invalid unitsPerInner", () => {
  const baseFormData: ProjectFormData = {
    ...
    intakeFee: "0", numPallets: "1", numIntakePallets: "1", inventoryHandlingFee: "0", intakeFeeMarkup: "0",
    testingEnabled: "true", testingRows: [], testingMarkup: "0",
    leftOverInventoryCost: "0", leftOverInventoryAbsorb: "0",
    setupFeeOur: "0", setupFeeCustomer: "0", projectManagementFee: "0", ppuDenominator: "100",
...
describe("Auto pallet calculation from project weight", () => {
  ...
  const baseFormData: ProjectFormData = {
    ...
    testingEnabled: "true", testingRows: [], testingMarkup: "0",
    leftOverInventoryCost: "0", leftOverInventoryAbsorb: "0",
    setupFeeOur: "0", setupFeeCustomer: "0", projectManagementFee: "0", ppuDenominator: "15000",
